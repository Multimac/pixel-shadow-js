...
module ShadowJS {
    ...
    export class Shadow {
        private m_errorLoading: boolean;
        public get errorLoading(): boolean { return this.m_errorLoading; }
        ...
        constructor(lightSize: number, options?: ShadowOptions) {
            options = Util.default(options, {});

            var targetSize = Util.default(options.renderTargetSize, lightSize);
            if (!Util.powerOfTwo(targetSize)) {
            ...
            this.m_threshold = Util.default(options.threshold, 0.25);

            this.m_minBlur = Util.default(options.minBlur, 0.0);
            this.m_maxBlur = Util.default(options.minBlur, 3.0);

            this.m_bias = Util.default(options.minBlur, 2.0);

            this.m_ambient = Util.default(options.minBlur, 0.25);
            this.m_exponent = Util.default(options.minBlur, 1.0);
    ...
    export class Util {
        public static default(val: any, def: any) {
            return (typeof (val) !== "undefined") ? val : def;
        }
        public static powerOfTwo(num: number) {
            if (num < 0) {
